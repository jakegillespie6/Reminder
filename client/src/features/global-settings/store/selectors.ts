...
export const selectCalendar = (state: RootState) => state.globalSettings.calendarFilters;
...
export const selectCalendarStatus = (state: RootState) => state.globalSettings.status.calendarFilters;
